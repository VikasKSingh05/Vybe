...
export default function PartyError({ error, reset }: ErrorBoundaryProps) {
  useEffect(() => {
    console.error("[VYBE] Party error:", error);
  }, [error]);
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0a0a0a] px-4 text-center">
      <div className="w-full max-w-md">
        ...
        <p className="mt-3 text-sm text-white/50">
          Something went wrong with the party. It may have ended or the connection was lost.
        </p>
        <button
          type="button"
          onClick={reset}
